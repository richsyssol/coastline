...
define('host_mail', ' your_email');
define('host_password', 'email_password');
...
if (isset($_POST['submit'])) {
    ...
    class Sendmail
    {
        ...
        public function sendingMail($rec, $name, $subject = "Subject Sample", $message = "This is default", $attachement = '')
        {
            ...
            try {
                ...
                $this->mail->Port       = 465;
                $this->mail->setFrom(host_mail, 'Coastline');
                $this->mail->addAddress($rec, $name);
                $this->mail->addReplyTo(host_mail, 'Coastline');
    ...
    if (isset($_POST['submit'])) {
        ...
        if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
            $messageTemplate = "<h4>User Details For Contact</h4>" . "<br>" . "Name:" . $_POST['name'] . "<br>" . "Email:" . $_POST['email'] . "<br>" . "Contact:" . $_POST['contact'] . "<br>" . "Service:" . $_POST['service'] . "<br>" . "Message:" . $_POST['message'];
